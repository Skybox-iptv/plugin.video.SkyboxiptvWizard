...
base='http://skyboxiptv.com'
ADDON=xbmcaddon.Addon(id='plugin.video.SkyboxiptvWizard')
dialog = xbmcgui.Dialog()    
VERSION = "2.1.119"
PATH = "SkyboxiptvWizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://twistedarcade.net/Wizard/wizard3.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]Skybox IPTV Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
...
def killxbmc():
    ...
    if myplatform == 'osx': # OSX
        ...
        try: os.system('killall -9 org.xbmc.kodi')
        except: pass
        try: os.system('killall -9 org.kodi')
        except: pass
        try: os.system('killall -9  org.xbmc.xbmc')
        except: pass
        try: os.system('killall -9  org.xbmc')
        except: pass        
